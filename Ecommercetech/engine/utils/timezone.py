...
def diff_years(from_year):
    """
    Return age difference in years.
    :param from_year:
    :return:
    """
    # year_delta = relativedelta.relativedelta(date.today(), from_year)
    # year_diff = float(year_delta.years * 12 + year_delta.months) / 12
    # return math.ceil(year_diff)
    return datetime.now().year - from_year + 1
